            ...
            <table class="table table-bordered">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th>
                            <a href="proj/create/" title="Adicionar">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a <?= 'href="proj/update/index.php?id=' . $proj->id . '"' ?> title="Editar">
                            ...
                            <a <?= 'href="proj/read/index.php?id=' . $proj->id . '"' ?> title="Detalhes">
                            ...
                            <a <?= 'href="proj/delete/index.php?id=' . $proj->id . '"' ?> title="Excluir">
