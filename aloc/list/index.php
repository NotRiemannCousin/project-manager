        ...
        <table class="table table-bordered">
            <thead class="thead-light">
                <tr>
                    ...
                    <th>
                        <a href="../create/dev-s.php" title="Adicionar">
            ...
            ?>
                <tr>
                    <td><?= $aloc->projeto->nome ?></td>
                    <td><?= $aloc->desenvolvedor->nome ?></td>
                    <td><?= $aloc->inicio ?></td>
                    <td><?= $aloc->termino ?></td>
                    <td><?= $aloc->remuneracao ?></td>
                    <td><?= $aloc->horas ?></td>
                    <td>

                        <a <?= 'href="../update/info.php?id=' . $aloc->id . '"' ?> title="Editar">
                        ...
                        <a <?= 'href="../read/index.php?id=' . $aloc->id . '"' ?> title="Detalhes">
                        ...
                        <a <?= 'href="../delete/?id=' . $aloc->id . '"' ?> title="Excluir">
