...
<body>
    ...
    <main>
        ...
        <table class="table table-bordered">
            ...
            ?>
                <tr>
                    <td><?= $task->alocacao->projeto->nome ?></td>
                    <td><?= $task->alocacao->desenvolvedor->nome ?></td>
                    <td><?= $task->descricao ?></td>
                    <td>

                        <a <?= 'href="../update/index.php?id=' . $task->id . '"' ?> title="Editar">
                        ...
                        <a <?= 'href="../read/index.php?id=' . $task->id . '"' ?> title="Detalhes">
                        ...
                        <a <?= 'href="../delete/index.php?id=' . $task->id . '"' ?> title="Excluir">
